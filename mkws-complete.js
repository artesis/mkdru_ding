/* created at: Thu Aug 22 09:52:46 UTC 2013
   mkws.js GIT id: d3b9f1529768e96c18dc8ce2e092c46e55495826 */
...
var pzHttpRequest = function ( url, errorHandler ) {
        ...
        if (xhr === null)
          throw new Error("CORS XMLHttpRequest not supported in"
            + " this browser");
        this.request = xhr;
};
...
pzHttpRequest.prototype =
{
    ...
    _send: function ( type, url, data, callback)
    {
        ...
        this.async = true;
        if (this.isXDomain && window.JSESSIONID) {
          var sessparam = ';jsessionid=' + window.JSESSIONID;
          var q = url.indexOf('?');
            if (q == -1) {
              url += sessparam;
            } else {
        ...
        if ( this.request.readyState == 4 ) {
            ...
            if (this.isXDomain) {
              if (this.request.contentType.match(/\/xml/)){
                ...
                //expect value in the root
                var jsessionId =
                  dom.documentElement.getAttribute('jsessionId');
                if (jsessionId)
